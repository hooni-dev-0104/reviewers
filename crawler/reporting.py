...
PUBLIC_SOURCE_SLUGS = ["4blog", "chehumview", "dinnerqueen", "modan", "reviewnote", "reviewplace", "revu", "seouloppa", "ringble", "nolowa", "gangnammatzip"]
...
def build_source_quality_report(result: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        f"- report_mode: {result.get('report_mode')}",
